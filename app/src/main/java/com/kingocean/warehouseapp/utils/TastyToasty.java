...
//    }
    ...
    public static Toast red(@NonNull Context context, String message, Integer iconId) {
        return makeText(context, message, LONG, iconId, R.color.tasty_red, R.color.tasty_white, false);
    }

    public static Toast orange(@NonNull Context context, String message, Integer iconId) {
        return makeText(context, message, LONG, iconId, R.color.tasty_orange, R.color.tasty_white, false);
    }

    public static Toast yellow(@NonNull Context context, String message, Integer iconId) {
        return makeText(context, message, LONG, iconId, R.color.tasty_yellow, R.color.tasty_white, false);
    }

    public static Toast green(@NonNull Context context, String message, Integer iconId) {
        return makeText(context, message, LONG, iconId, R.color.tasty_green, R.color.tasty_white, false);
    }

    public static Toast blue(@NonNull Context context, String message, Integer iconId) {
        return makeText(context, message, LONG, iconId, R.color.tasty_blue, R.color.tasty_white, false);
    }

    public static Toast indigo(@NonNull Context context, String message, Integer iconId) {
        return makeText(context, message, LONG, iconId, R.color.tasty_indigo, R.color.tasty_white, false);
    }
    public static Toast violet(@NonNull Context context, String message, Integer iconId) {
        return makeText(context, message, LONG, iconId, R.color.tasty_violet, R.color.tasty_white, false);
    }
    ...
    public static Toast makeText(@NonNull Context context, String message, Integer duration, Integer iconId, Integer backgroundColorId, Integer textColorId, Boolean showTail) {
        ...
        if (backgroundColorId != null) {
            ...
            //Default
            toastContainer.setBackgroundColor(context.getResources().getColor(R.color.tasty_insta_red));
            imgTail.setColorFilter(ContextCompat.getColor(context, R.color.tasty_insta_red), android.graphics.PorterDuff.Mode.SRC_IN);
        }
        ...
        if (textColorId != null) {
            ...
            tvMessage.setTextColor(context.getResources().getColor(R.color.tasty_white));
        }
